...
class MultioutRegressorNETV3(BaseNetwork):
    def __init__(
        self,
        ...
        """
        super(MultioutRegressorNETV3, self).__init__(loss_method=loss_method)
        ...
        # output_size = int((input_size + self.out_features) / 2)
        output_size = 40
        end_layers = [
