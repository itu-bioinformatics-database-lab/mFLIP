...
class PerformanceMetrics:
    ...
    def __init__(
        ...
        self.scaler = scaler
        self.metrics = {
            "test_time_mixed": test_time,
            "test_time_min": test_time,
            "test_time_max": test_time,
            "validation_time_mixed": validation_time,
            "validation_time_min": validation_time,
            "validation_time_max": validation_time,
            "train_time_mixed": train_time,
            "train_time_min": train_time,
            "train_time_max": train_time,
        }
    ...
    def complete(self):
        ...
        self.fpath = os.path.join(
            outputs_dir, f"performance_metrics_{self.experience_name}.csv"
        )
