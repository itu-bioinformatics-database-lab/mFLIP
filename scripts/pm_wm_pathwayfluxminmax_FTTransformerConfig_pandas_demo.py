...
for fold in fold_list:
    ...
    model_config_params = {
        ...
        # "use_batch_norm": True,
        # "dropout": 0.3,
        "learning_rate": 0.00012022644346174131,
    }
    target_range = True
    if target_range:
        _target_range = []
    ...
    model = TabularModel.load_model(outputs_dir / f"pm_wm_pathwayfluxminmax_FTTransformerConfig_pandas_fold_{fold}_tabular")
    ...
    if not model_file_path.exists():
        ...
        # config = FTTransformerConfig.load_model(model_file_path / "config.yaml")
