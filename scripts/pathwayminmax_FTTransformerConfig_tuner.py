...
search_space = {
    # "model_config__input_embed_dim": [8, 32, 256],
    "model_config__num_attn_blocks": [8, 32],
    "model_config__num_heads": [8, 32],
    "model_config__attn_dropout": [0.3, 0.5],
    "model_config__add_norm_dropout": [0.3, 0.5],
    "model_config__ff_dropout": [0.3, 0.5],
    "model_config__ff_hidden_multiplier": [4, 10],
