...
for experiment_name in experiment_name_list:
    ...
    for fold in fold_list:
        ...
        for ds_name in test_source_list:
            ...
            import pandas as pd
            pd.DataFrame(y_true, columns=list(test_all_dataset.label_df.columns)).to_csv(f"true_{experiment_name}_{ds_name}_{fold}.csv")
            pd.DataFrame(y_pred, columns=list(test_all_dataset.label_df.columns)).to_csv(f"pred_{experiment_name}_{ds_name}_{fold}.csv")
