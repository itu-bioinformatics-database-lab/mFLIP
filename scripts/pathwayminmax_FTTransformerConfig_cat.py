...
# train_df = train_df.applymap(lambda x: np.digitize(x, metabolite_bins))
# test_df = test_df.applymap(lambda x: np.digitize(x, reaction_bins))


train_df[num_col_names] = train_df[num_col_names].applymap(lambda x: np.digitize(x, metabolite_bins))
# train_df[target_columns] = train_df[target_columns].applymap(lambda x: np.digitize(x, reaction_bins))

test_df[num_col_names] = test_df[num_col_names].applymap(lambda x: np.digitize(x, metabolite_bins))
# test_df[target_columns] = test_df[target_columns].applymap(lambda x: np.digitize(x, reaction_bins))
