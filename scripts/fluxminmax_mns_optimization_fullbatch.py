...
if __name__ == "__main__":
    ...
    pipeline.train_all_models(dataset=uniform_dataset, num_epochs=10000, batch_size=1024, num_workers=32, prefetch_factor=2, validation_dataset=aycans_dataset, eval_every=100)
