...
for fold in list(range(k_folds)):
    ...
    print(f"{fold = }")
    print(f"{len(train_all_dataset) = }")
    print(f"{len(validation_all_dataset) = }")
    print(f"{len(test_all_dataset) = }")
    
    print(f"{train_all_dataset.label_df.min().min() = }")
    print(f"{train_all_dataset.label_df.max().max() = }")

    print(f"{train_all_dataset.metabolomics_df.min().min() = }")
    print(f"{train_all_dataset.metabolomics_df.max().max() = }")
