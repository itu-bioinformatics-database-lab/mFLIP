...
model_config_params = {
    ...
    "gflu_stages": 32,
    "gflu_dropout": 0.3,
    "gflu_feature_init_sparsity": 0.4,
...
search_space = {
    "model_config__gflu_stages": [8, 32, 256],
    "model_config__gflu_dropout": [0.2, 0.5],
    "model_config__gflu_feature_init_sparsity": [0.3, 0.5],
    "model_config__learnable_sparsity": [True, False],
    "model_config__batch_norm_continuous_input": [True, False],
