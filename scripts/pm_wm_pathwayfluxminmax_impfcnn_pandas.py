...
from deep_metabolitics.networks.metabolite_impfcnn import MetaboliteImpFCNN
...
experiment_name = f"2{experiment_name}_{metabolite_scaler_method}_{target_scaler_method}_{metabolite_coverage}_{k_folds}_{batch_size}"
