...
if __name__ == "__main__":
 ...
 'EX_strch2_e']
    ...
    # %%
    from deep_metabolitics.networks.multi_model_combined_fluxminmax_nobatch import (
    ...
    pipeline = MultiTargetTrainingPipeline(
        ...
        lr=0.001,
        weight_decay=0.01,
        tag=f"fullbatch_bigmodel_0001_lossth_10kepochs_0001lr_{metabolite_scaler_method}_{target_scaler_method}_15grclipping_v2"
    )
