...
print(f"{mean_absolute_error(uniform_dataset.scaler.inverse_transform(test_df[target_columns]), uniform_dataset.scaler.inverse_transform(pred_df_copy[target_columns])) = }")
print(f"{mean_squared_error(uniform_dataset.scaler.inverse_transform(test_df[target_columns]), uniform_dataset.scaler.inverse_transform(pred_df_copy[target_columns])) = }")
print(f"{r2_score(uniform_dataset.scaler.inverse_transform(test_df[target_columns]), uniform_dataset.scaler.inverse_transform(pred_df_copy[target_columns])) = }")
print(f"{mean_absolute_percentage_error(uniform_dataset.scaler.inverse_transform(test_df[target_columns]), uniform_dataset.scaler.inverse_transform(pred_df_copy[target_columns])) = }")
