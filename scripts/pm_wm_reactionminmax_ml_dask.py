...
from deep_metabolitics.data.metabolight_dataset_dask import MultioutDataset
...
experiment_name = f"dask_{experiment_name}_{metabolite_scaler_method}_{target_scaler_method}_{metabolite_coverage}_{k_folds}_{batch_size}"
