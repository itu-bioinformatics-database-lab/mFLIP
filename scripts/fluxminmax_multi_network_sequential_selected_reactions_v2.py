...
if __name__ == "__main__":
    ...
    pipeline = MultiTargetTrainingPipeline(
        ...
        lr=0.001,
        weight_decay=0.01,
        tag=f"8kbatch_bigmodel_0001_lossth_10kepochs_0001lr_{metabolite_scaler_method}_{target_scaler_method}_15grclipping"
    )

    # %%
    # Eğitim sürecini başlat
    pipeline.train_all_models(dataset=uniform_dataset, num_epochs=10000, batch_size=8192, num_workers=4, prefetch_factor=2, validation_dataset=aycans_dataset, eval_every=100)
